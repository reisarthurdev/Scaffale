  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{
        ...
        <p style={{ color: 'var(--muted)', font: '18px justsans', textAlign: 'center', margin: '0 0 32px' }}>Entrar na sua conta</p>
        ...
        <div style={{ textAlign: 'center', marginTop: 24, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <Link to="/forgot-password" style={{ color: 'var(--muted)', font: '16px justsans' }}>Esqueci minha senha</Link>
          <p style={{ color: 'var(--muted)', font: '16px justsans', margin: 0 }}>
            Não tem conta?{' '}
            <Link to="/register" style={{ color: 'var(--text)', borderBottom: '1px solid var(--text)' }}>Cadastre-se</Link>
          </p>
        </div>
      </div>
    </div>
